const monuments = [
  {
    ...
    story_tr: `Budapeşte’nin tam kalbinde, Gellért Tepesi’nin zirvesinde yükselen bir kadın figürü vardır. Elinde göğe doğru uzattığı bir palmiye dalı tutar. İlk bakışta sade gibi görünse de, ardında yatan hikâye, Macaristan’ın yüzyıllara yayılan özgürlük arzusunu taşır.
          Bu heykel, 1947 yılında II. Dünya Savaşı’nın ardından dikildi. Başlangıçta Sovyet zaferini onurlandırmak amacıyla yapılmıştı. Fakat zamanla, bu anıtın anlamı değişti. Sovyet dönemi sona erdiğinde, halk bu heykeli yıkmak yerine ona yeni bir anlam yüklemeyi tercih etti. Sovyet sembolleri kaldırıldı ve anıt, artık Macaristan’ın kendi özgürlük mücadelesine adandı.
          Heykelin altındaki yazıtta şöyle yazar: “Macaristan’ın özgürlüğü için hayatını kaybedenlere...” Bu sade cümle, aslında büyük bir acının ve kararlılığın ifadesidir. Artık bu heykel bir işgalin değil, bir halkın direnişinin, yeniden doğuşunun simgesidir.
          Günümüzde gece ışıklandırmalarıyla tüm şehirden görülebilen bu heykel, Budapeşte manzarasının ayrılmaz bir parçasıdır. Onun gölgesinde yürüyen herkes, geçmişin izlerini ve özgürlüğün ne kadar değerli olduğunu hisseder. Rüzgarla birlikte dalgalanan palmiye dalı, her zaman bir umut taşır – tıpkı Macar halkının kalbindeki sönmeyen özgürlük arzusu gibi.
            `,
    story_en: `At the very heart of Budapest, high atop Gellért Hill, stands the figure of a woman, holding a palm leaf raised toward the sky. At first glance, she may seem simple. But behind her presence lies the story of a nation's long, hard-fought yearning for freedom.
          The statue was erected in 1947, in the aftermath of World War II. Initially, it was meant to honor the Soviet victory. But as time passed, its meaning began to shift. When the Soviet era ended, the people of Hungary chose not to tear the monument down. Instead, they gave it a new spirit. The Soviet symbols were removed, and the statue was rededicated to Hungary's own struggle for freedom.
          The inscription at its base now reads: “To those who gave their lives for the freedom of Hungary.” A simple sentence—yet it carries the weight of sacrifice, defiance, and resilience. Today, the statue stands not as a relic of occupation, but as a beacon of the people’s resistance and rebirth.
          Illuminated at night, visible from nearly every corner of the city, the Liberty Statue is more than a landmark. It is a part of Budapest’s soul. Anyone walking beneath its shadow feels the echoes of history and the enduring value of freedom. And as the wind stirs the palm branch in her hand, one can still sense the quiet, unshakable hope that lives on in the heart of Hungary.`,
    image:
  ...
  },
  {
    ...
    story_tr: `Budapeşte’nin tam kalbinde yer alan Kahramanlar Meydanı, sadece büyük heykellerle süslenmiş görkemli bir alan değil, aynı zamanda Macar ulusunun tarihine açılan sessiz bir anlatıcı gibidir. Her taşı, her figürü, geçmişin izlerini bugüne taşıyan anlamlarla doludur.
          Bu etkileyici meydan, 1896 yılında, Macaristan’ın kuruluşunun 1000. yılı onuruna inşa edildi. Ortasında yükselen Milenyum Anıtı, ülkeyi kuran yedi Macar kabilesinin liderlerini onurlandırır. Heykellerin en önünde yer alan Árpád, bu yolculuğun başlangıcını simgeler. O ve diğer kabile liderleri, sadece tarihî figürler değil; bir halkın köklerine duyduğu saygının temsilcileridir.
          Anıtın arkasındaki yarım daire şeklindeki sütunlar, Macar tarihine yön vermiş kralların, devlet adamlarının ve kahramanların heykelleriyle çevrilidir. Her biri, kendi döneminin ruhunu yansıtır. Kimisi bir savaşı, kimisi bir barışı, kimisi de halkına umut olmayı temsil eder.
          Kahramanlar Meydanı yıllar boyunca sadece bir anıt alanı olmaktan öteye geçti. Burada bayramlar kutlandı, yaslar tutuldu, millet tek yürek oldu. Her bir tören, meydanın tarihine yeni bir anlam kattı.
          Bugün bu meydana gelen herkes, yalnızca taşlardan ve bronzdan oluşan bir yapıyla değil, geçmişin fısıltılarıyla karşılaşır. Ve sanki meydan, her ziyaretçisine şu mesajı söyler:
          "Bir ulusun büyüklüğü, geçmişine sahip çıkmasıyla ölçülür."`,
    story_en: `In the very heart of Budapest lies Heroes’ Square — not just a monumental space adorned with statues, but a silent narrator of Hungary’s deep-rooted history, struggles, and triumphs. Every stone, every figure carries echoes of a proud past.
          This iconic square was built in 1896 to celebrate the 1000th anniversary of Hungary’s founding. At its center stands the Millennium Monument, paying tribute to the seven chieftains who led the Hungarian tribes to this land. At the forefront is Árpád, symbolizing the beginning of a nation’s journey. These leaders are more than just historical figures — they represent a nation’s reverence for its origins.
          Behind the central column, a semicircular colonnade embraces the square. Here, the statues of kings, statesmen, and national heroes tell stories of different eras — some of war, others of peace, and all of resilience.
          Over the years, Heroes’ Square has been more than just a historic site. It has witnessed national celebrations, solemn commemorations, and powerful moments of unity. Each event has added a new layer to its story.
          Today, those who walk through the square encounter more than bronze and stone. They step into a space where history still speaks — and gently whispers this message:
          "The greatness of a nation is measured by how it honors its past."`,
    image:
  ...
  },
  {
    ...
    story_tr: `Budapeşte’nin Buda yakasında, Tuna Nehri’ne nazır yamaçlarda yükselen Balıkçılar Burcu, yalnızca taşlardan örülmüş bir seyir terası değildir. O, geçmişin sesini bugüne taşıyan, bir milletin efsanelerini gökyüzüne fısıldayan zarif bir yapıttır. 1902 yılında tamamlanan bu neo-Gotik ve neo-Romanesk tarzda inşa edilmiş burç, adını bir zamanlar bölgeyi savunmakla görevli balıkçılardan alır. Bu ad, sıradan bir savunma birimini değil, halkın kendi evlerini ve şehirlerini korumak için gösterdiği cesaretin ve bağlılığın bir nişanesidir.
          Burcun yedi kulesi, Macaristan’ı kuran yedi kabileyi temsil eder. Bu kuleler yalnızca mimari bir detay değil; geçmişten bugüne uzanan bir zincirin her bir halkası gibidir. Her biri farklı bir hikâyeyi, farklı bir lideri, farklı bir umudu temsil eder. Taşların arasına işlenmiş o ince detaylar, sadece usta ellerin değil, büyük bir tarihî hafızanın izlerini taşır.
          Zamanla bu burç, yalnızca bir koruma noktası değil, aynı zamanda bir gözlem yeri haline gelmiştir. Bugün buradan bakıldığında görülen manzara, insanın içini hem hüzün hem de huzurla doldurur. Parlamentonun büyüleyici silueti, Tuna Nehri’nin nazlı akışı, karşı kıyının tarih kokan sokakları… Hepsi, geçmişin bugüne selam durduğu bir tablo gibidir.
          Balıkçılar Burcu, geceleri ışıklarla bezendiğinde bir masalın içine düşmüş hissi verir insana. Sessizlik içinde yankılanan tarih, rüzgarla fısıldayan taşlar ve gözlerden okunmayan hikâyeler… Bu burç sadece fotoğraf karelerine sığmayan bir güzellik değil, aynı zamanda kalpten kalbe işleyen bir hafıza mekânıdır.
          Her ziyaretçi, burada zamanın durduğunu hisseder. Çünkü Balıkçılar Burcu, Budapeşte’nin kalbinde atmaya devam eden bir anı gibidir. Ve o, her gece yıldızların altında tek bir şey söyler gibi durur:
          “Geçmişini unutmayanlar, geleceğini yıkılmaz temeller üzerine kurar.”`,
    story_en: `Standing proudly on the Buda side of Budapest, overlooking the gentle flow of the Danube, the Fisherman’s Bastion is far more than a panoramic terrace built of stone. It is a silent guardian of legends, a bridge between centuries, and a poetic whisper of Hungary’s soul to the skies above. Completed in 1902 in neo-Gothic and neo-Romanesque styles, the bastion takes its name from the fishermen who once defended this stretch of riverbank. But this name represents more than just a defense line; it stands as a tribute to the courage and unity of ordinary people who chose to protect their homes with unwavering determination.
          Its seven towers are not mere architectural ornaments. Each symbolizes one of the seven Magyar tribes that founded the Hungarian nation. These towers are like stone storytellers—each carrying a legend, a hero, a beginning. Woven into their walls are intricate designs that speak of a time long gone but not forgotten. These carvings are the fingerprints of history, left for those who are willing to see beyond stone.
          Over the decades, the bastion transformed from a defensive post into one of the most beloved observation points in the city. From here, the view unfolds like a living painting: the Hungarian Parliament’s iconic silhouette, the winding Danube reflecting the city lights, and the historic streets of Pest stretching out beyond. At sunset, the entire scene is bathed in gold, offering visitors a moment where time seems to pause.
          At night, when the Fisherman’s Bastion glows softly under the stars, it feels as if you’ve stepped into a fairy tale. The silence carries whispers of history, and every stone seems to hum with stories untold. It is not just a place for taking pictures—it’s a place where your heart listens.
          Visitors leave with more than memories. They leave with a sense of something greater—something timeless. For this bastion, rooted in the heart of Budapest, seems to whisper the same message to all who pass:
          "Those who honor their past, build their future upon unshakable foundations."`,
    image:
  ...
  },
  {
    ...
    story_tr: `Tuna Nehri’nin huzurlu akışı boyunca yükselen Parlamento Binası, Budapeşte'nin siluetinde yalnızca dikkat çeken bir yapı değil; aynı zamanda bir milletin tarihini, umudunu ve kararlılığını taşıyan görkemli bir simgedir.
          1896 yılında temeli atılan ve 1904'te tamamlanan bu görkemli yapı, Macaristan'ın bininci kuruluş yılına ithafen inşa edilmiştir. Neo-Gotik mimarinin en güzel örneklerinden biri olan bina, aynı zamanda barok ve Rönesans detaylarını da barındırarak mimari bir sentez sunar. Her detayıyla ince işçilik barındıran cephesi, yalnızca bir estetik değil; tarihî ve ulusal bir anlatıdır.
          Parlamento’nun çift kanatlı yapısı, devletin yasama ve yürütme organlarını temsil ederken; merkezde yükselen dev kubbe, birliğin ve millet iradesinin sembolüdür. 691 odası, 27 kapısı ve 29 merdiveniyle adeta bir sarayı andıran bu yapı, içine giren herkese Macar tarihinin ihtişamlı sayfalarını fısıldar.
          Binanın içi de dışı kadar etkileyicidir. Altın varaklı salonlar, tarihî tablolar, görkemli merdivenler ve Kutsal Macar Tacı’nın sergilendiği özel bölüm, ziyaretçilere hem ulusal gururu hem de tarihî derinliği bir arada sunar. Parlamento, sadece politik kararların alındığı bir merkez değil; geçmişle bugünü buluşturan yaşayan bir mirastır.
          Bugün Parlamento Binası, Macar halkı için bir gurur kaynağı, dünya ziyaretçileri içinse mimari bir başyapıt olarak varlığını sürdürmektedir. Tuna’nın kıyısında altın ışıklarla yansıyan bu yapı, gelen herkese aynı mesajı fısıldar:
          “Bir milletin kalbi, özgürlükle atan tarihî yapılarda atmaya devam eder.”`,
    story_en: `Rising with majestic elegance along the banks of the Danube, the Hungarian Parliament Building is not just an architectural marvel — it is a symbol that unites a nation's history, aspirations, and enduring pride.
          Its foundation was laid in 1896 to celebrate the thousandth anniversary of the Hungarian state, and it was completed in 1904. Designed in a stunning Neo-Gothic style with hints of Baroque and Renaissance influence, the Parliament Building stands as one of the most iconic legislative structures in the world. Its richly decorated façade tells not just a visual story but a national one.
          The building's two symmetrical wings represent the legislative and executive branches of the government, while the massive central dome symbolizes unity and national sovereignty. With 691 rooms, 27 gates, and 29 staircases, the structure is as grand inside as it is outside — almost like a palace dedicated to the people.
          Inside, visitors are greeted by golden-hued chambers, monumental stairways, historic murals, and the sacred Hungarian Crown, which is displayed in a special chamber beneath the dome. Every hall whispers stories of the country’s past, its struggles, and its triumphs.
          More than a place of governance, the Parliament is a living monument — one that bridges Hungary's historic identity with its modern democratic spirit.
          Today, it remains a source of national pride for Hungarians and a breathtaking landmark for visitors from around the globe. Reflected in the golden light of the Danube, it gently reminds all who see it:
          “The heart of a nation beats strongest in the monuments it builds with hope and history.”
          `,
    image:
...
`,
...

  {
    ...
    story_tr: `Budapeşte’nin Karinthy Kert bölgesinde yükselen Szent Imre Heykeli, genç prensin erdemli ve umut dolu yaşamının sessiz bir temsilcisidir. Szent Imre, Macar kraliyet ailesinin önemli bir üyesi, aynı zamanda Aziz Imre olarak bilinen bir figürdür. Hayatı, genç yaşta sona ermiş olsa da ardında büyük bir miras bırakmıştır.
      Imre, babası Kral István’ın yolundan giderek, eğitime ve ahlaka büyük önem verdi. O sadece bir prens değil, aynı zamanda ülkesinin geleceğine dair umutların taşıyıcısıydı. Dini inancı ve adalet anlayışı, onu halkının sevgisini kazanan bir lider yaptı. Genç yaşında hayatını kaybetmesi, onu efsanevi bir kahraman haline getirdi.
      Bu heykel, bize gücün sadece tahta oturmakla değil, bilgelik, sevgi ve sorumlulukla yönetmekle anlam kazandığını hatırlatıyor. Szent Imre’nin duruşu, gençlere erdemli olmanın, cesaretle doğruyu savunmanın önemini anlatıyor. Gelecek nesiller için ilham kaynağı olmayı sürdürüyor.
      Heykelin önünde durduğunuzda, onun size sessizce şöyle dediğini hissedersiniz: “Geleceği şekillendirmek senin elinde. Cesaretinle, bilginle, erdeminle dünyayı değiştirebilirsin.” Bu yüzden Szent Imre, sadece tarih sayfalarında değil, her yeni günde hayatımızda da yaşamaya devam ediyor.`,
    story_en: `Standing proudly in Budapest’s Karinthy Kert, the Statue of Saint Emeric quietly honors the virtuous and hopeful life of the young prince. Saint Emeric was a key member of the Hungarian royal family and is known as a saint. Though his life was cut short at a young age, his legacy remains powerful.
      Emeric followed in the footsteps of his father, King Stephen, placing great importance on education and moral integrity. He was not merely a prince, but a bearer of hope for his country’s future. His faith and sense of justice won him the love and respect of his people. His early death only elevated him into the realm of legend.
      This statue reminds us that true power isn’t just about sitting on a throne — it’s about ruling with wisdom, love, and responsibility. Emeric’s stance speaks to young people everywhere about the importance of virtue and courage to stand for what is right. He continues to inspire future generations.
      When you stand before this statue, you can almost hear a silent message: “The future is in your hands. With your courage, knowledge, and virtue, you can change the world.” Saint Emeric lives not only in history books but also in the spirit of every new day.`,
    image:
...
For those who stumble upon it, the statue provides more than a lesson in architectural history—it offers a journey through a nation’s evolving identity in form and style. In its silence lies a whisper: “Build upon the land that inspires you—art lives not by time, but by spirit.”`,
  ...
  },
  {
    ...
    longitude: 19.045376208080587,
    story_tr: ` Macaristan Parlamento Binası’nın ön cephesinde, Tuna Nehri’ne doğru dönük olarak duran gösterişli bir figür vardır: Gyula Andrássy’nin heykeli. Bronzdan dökülmüş bu zarif ve güçlü heykel, sadece bir adamın değil, bir dönemin ruhunu yansıtır. Atının üstünde kararlı ve gururlu bir duruş sergileyen Kont Andrássy, Macar tarihinin en çalkantılı ve dönüştürücü dönemlerinden birinde devlet gemisini yönlendiren önemli bir figürdü.
Gyula Andrássy, 19. yüzyılın ortalarında, Macar halkının özgürlük arayışıyla çalkalandığı bir çağda sahneye çıktı. 1848 Devrimi'nin ateşli savunucularından biri olarak, Avusturya'ya karşı bağımsızlık savaşında aktif rol oynadı. Bu cesur duruşu onu vatan haini ilan ettirse de, yıllar sonra aynı adam, Avusturya-Macaristan İmparatorluğu’nun dışişleri bakanı ve Macaristan başbakanı olarak yeniden tarih sahnesine çıktı.
Heykelin öyküsü, işte bu çelişkilerle dolu bir hayatın anısına şekillendi. Kont Andrássy, hem romantik bir idealist hem de gerçekçi bir diplomat olarak tanındı. Tuna Nehri kıyısında yükselen bu anıt, onun hem halkına duyduğu sevgiye hem de Avrupa'nın karmaşık dengeleri arasında gösterdiği diplomatik ustalığa saygı duruşudur.
Heykelin detaylarına yakından bakıldığında, sanatçının sadece fiziksel bir benzerlik değil, bir karakter portresi çizdiği anlaşılır. Atın güçlü kasları, Andrássy’nin enerjisini; sert bakışları ise kararlılığını temsil eder. Sol elinde tuttuğu belge, onun fikirlerinin silah kadar etkili olduğunu hatırlatır. Çünkü Andrássy’nin en büyük gücü, kılıçta değil kelimelerdeydi.
Bu anıt, sadece turistlerin önünde fotoğraf çektirdiği bir yapı değildir. Aynı zamanda Macar halkına hatırlatıcı bir mesajdır: Liderlik, yalnızca güçlü olmak değil, zor zamanlarda doğru kararları cesaretle alabilmektir. Gyula Andrássy’nin heykeli, bu liderliğin somutlaştığı bir simgedir.
Ve her gün, Parlamento’nun önünden geçen binlerce insanın bakışlarında, bu sessiz bronz figürün yankısı duyulur. Tarih, bazen sadece kitaplarda değil, sokak köşelerinde, meydanlarda ve heykellerde de anlatılır. Andrássy'nin hikâyesi de tam olarak burada, Tuna’nın kıyısında, bronza kazınmış bir hatıra olarak yaşamaya devam eder.`,
    story_en: `In front of the Hungarian Parliament Building, facing the Danube River, stands a striking figure: the statue of Count Gyula Andrássy. Cast in bronze, this elegant yet powerful monument captures not only the essence of a man but the spirit of an entire era. Sitting atop his horse with a proud and determined stance, Count Andrássy was one of the key figures who steered Hungary through one of its most turbulent and transformative periods.
Gyula Andrássy emerged during the mid-19th century, a time when Hungary was engulfed in the fires of revolution and a yearning for freedom. As a passionate supporter of the 1848 Revolution, he took an active role in the fight for independence against Austria. His bold stance led to his exile and even a death sentence in absentia. Yet, years later, this very same man returned as Hungary’s Prime Minister and later as Foreign Minister of the Austro-Hungarian Empire.
The statue was erected to honor this life full of contradictions—of rebellion and diplomacy, of exile and leadership. Andrássy was both a romantic idealist and a pragmatic statesman. The monument rising along the Danube pays tribute not only to his devotion to the Hungarian people but also to his diplomatic finesse amid the complex web of European politics.
Looking closely at the details of the statue, one sees more than just a physical resemblance—it is a portrait of character. The strong muscles of the horse represent Andrássy’s energy; his firm gaze symbolizes his resolve. The scroll in his left hand is a subtle reminder that his true strength lay not in the sword, but in the power of his words and vision.
This monument is not merely a backdrop for tourist photos. It is a silent yet powerful message to the Hungarian people: that leadership is not just about strength, but about making courageous decisions in difficult times. The statue of Gyula Andrássy stands as a symbol of such leadership.
Every day, as thousands pass by the Parliament, their glances are met by the quiet presence of this bronze figure. History is not only found in books—it lives in the corners of streets, in public squares, and in statues. Andrássy’s story, carved in bronze, continues to live on the banks of the Danube as a timeless reminder of courage, diplomacy, and national pride.`,
  ...
  },
  {
    ...
    story_tr: `Parlamentonun hemen kıyısında, Tuna Nehri'nin huzur veren akışıyla karşı karşıya duran bir bankta oturur Attila József'in heykeli. Şehrin gürültüsünden uzak, ama bir o kadar da şehrin kalbindedir. Ceketinin yakaları hafifçe rüzgârla kıpırdar gibi şekillendirilmiş, bakışları nehrin ötesine, belki geçmişe, belki de bilinmez bir geleceğe çevrilmiştir. Bu yalnız ve düşünceli duruş, yalnızca bir şairin değil, bir milletin duygularına da ayna tutar.
Attila József, Macar edebiyatının en güçlü, en kırılgan ve en derin kalemlerinden biriydi. Hayatı boyunca yoksullukla, ruhsal çöküntülerle ve toplumsal adaletsizlikle boğuşmuş; ama her dizesinde insan ruhunun derinliklerine inmeyi başarmıştı. 32 yıllık kısa ömrüne sığdırdığı eserler, yalnızca kendi acılarını değil, toplumun da çığlığını yansıtır. Bu yüzden heykeli de herhangi bir zaferin ya da siyasi figürün yüceltilmesinden farklıdır. O, sessiz bir farkındalığın, içsel bir isyanın simgesidir.
Heykelin konumu tesadüfi değildir. Parlemento binasının karşısında, sistemin tam kalbine yerleştirilmiş olması, onun şiirlerinde sıkça dile getirdiği sosyal adaletsizlik, yoksulluk ve eşitsizlik temalarına ironik bir karşı duruştur. Orada, o bankta otururken sanki hâlâ gözlemlemeye, anlamaya ve anlatmaya devam eder. Kimseye sesini yükseltmez, ama herkese içtenlikle konuşur.
Yanından geçen bir çocuk, heykelin yalnızlığında oyun oynamaya karar verir. Bir turist, cebinden çıkardığı kitabın sayfalarını rüzgârla karıştırırken, göz ucuyla ona bakar. Bir edebiyat öğrencisi, defterine notlar alırken şairin suskunluğunda ilham bulur. Böylece heykel, sadece bir sanat eseri değil, yaşayan bir hafıza haline gelir.
Attila József’in bu heykeli, şiirin yalnızca kağıtta değil, taşta da yaşadığını kanıtlar. Ve her gün, binlerce insanın gözünden süzülerek sessizce dile gelir: "Bir gün belki biz de bu nehrin kenarında, içimizdeki fırtınalarla barış içinde oturabiliriz."
`,
    story_en: `Sitting quietly on a bench by the Danube River, opposite the grand Hungarian Parliament, is the statue of Attila József. It's far from the noise of the city, yet deeply rooted in its very soul. The collar of his coat seems to flutter slightly in the breeze, and his gaze stretches beyond the water—perhaps into the past, or into an unknown future. This solitary, thoughtful posture reflects not just a poet’s inner world but also the emotions of an entire nation.
Attila József was one of the most powerful, vulnerable, and profound voices in Hungarian literature. Throughout his life, he struggled with poverty, mental health, and societal injustice. Yet in every line of his poetry, he managed to delve into the deepest corners of the human soul. His brief 32 years on earth produced works that captured not only his personal pain but also the collective cries of his people. That’s why his statue doesn’t celebrate victory or political power. Instead, it embodies quiet awareness and internal resistance.
The statue's placement is no accident. Positioned directly across from the Parliament building—the heart of the system—it serves as a silent critique of the social inequality, poverty, and injustice that József so often wrote about. Sitting there on the bench, it feels as though he is still observing, understanding, and speaking through silence. He raises his voice to no one, yet speaks sincerely to all.
A child passing by might decide to play near the statue’s solitude. A tourist flipping through the pages of a book might glance at him with curiosity. A literature student taking notes might find inspiration in his silent presence. In this way, the statue becomes more than art—it transforms into living memory.
Attila József’s statue proves that poetry doesn’t only live on paper—it lives in stone as well. And every day, it softly whispers through the eyes of those who pass by: “One day, perhaps we too can sit by this river in peace, with the storms inside us finally calmed.”`,
    image:
...
Yine de anıtın önünden geçen herkes, bir an için durur. Kimisi dua eder, kimisi düşünür, kimisi sadece taşların arasındaki tarihin yankısını dinler. Budapeşte’nin göbeğinde, sessiz bir direniş gibi yükselen bu yapı, savaşın yıkıcılığını hatırlatırken aynı zamanda barışın ne kadar kıymetli olduğunu da fısıldar.`,
    story_en: `In the heart of Budapest, standing quietly among the buildings that have witnessed countless conflicts and transformations, the Soviet War Memorial rises in Szabadság Square. Its surface may appear plain, even cold, but the story behind this monument is woven with the devastation of war, the weight of victory, and the complex memory of history.
Erected in 1945, the monument honors the Soviet soldiers who liberated Budapest from Nazi occupation during World War II. The arrival of the Red Army marked a turning point in Hungary’s history. While it ended the tyranny of the Nazis, it also ushered in decades of socialist rule and Soviet influence. Therefore, this monument symbolizes not only a military triumph but also a complex and multilayered past.
Atop the tall stone block sits a golden emblem bearing the Soviet star. This simple yet striking symbol rises skyward, honoring the memory of ideology and sacrifice. The inscriptions surrounding the monument are dedicated to the thousands of Red Army soldiers who lost their lives in Budapest. Each line feels like the silent cry of a family’s lost son, a young life fallen on foreign soil.
But the significance of the Soviet War Memorial goes beyond the past. Over time, it has become not only a site of remembrance but also a stage for political debate, historical reflection, and collective memory. For some, it remains a symbol of liberation; for others, a reminder of an imposed ideology. This duality has always infused the space around the monument with mixed emotions.
And yet, everyone who passes by the memorial pauses for a moment. Some offer a prayer, others reflect silently, and some simply listen to the echo of history in the stones. Standing like a quiet resistance in the center of Budapest, this structure reminds us of the destruction of war—while softly whispering the value of peace.`,
  ...
  },
  {
    ...
    longitude: 19.049888524649088,
    story_tr: `Budapeşte’nin Szabadság Meydanı’nda yer alan Ronald Reagan Heykeli, özgürlüğün ve totaliter rejimlere karşı verilen mücadelenin simgesel bir temsilidir. Amerikalı Başkan Ronald Reagan’ın bu meydanda bir anıtla onurlandırılması, Macar halkının ve Orta Avrupa’nın Sovyet etkisinden kurtuluşunda oynadığı önemli rolün bir yansımasıdır.
1980’li yıllarda, Soğuk Savaş’ın son evrelerinde Reagan, özgürlükçü politikaları ve Sovyetler Birliği’ne karşı yürüttüğü kararlı duruşuyla tanınmıştı. Macaristan gibi birçok Orta ve Doğu Avrupa ülkesi, onun liderliğinde şekillenen Batı'nın siyasi duruşundan güç aldı. Reagan, “kötülük imparatorluğu” olarak adlandırdığı Sovyet rejimine karşı ekonomik ve ideolojik mücadeleler yürüterek Doğu Bloğu’nun çözülmesini hızlandıran figürlerden biri oldu. Onun liderliği, Macaristan’da komünist rejimin sona ermesiyle sonuçlanan büyük dönüşüm sürecine ilham verdi.
Heykelin konumu da oldukça anlamlıdır. Szabadság Meydanı, hem geçmişteki Sovyet etkisinin hem de günümüzdeki demokratik değerlerin sembolik bir kesişim noktasıdır. Ronald Reagan Heykeli, meydana yürüyen bir figür olarak tasvir edilmiştir; bu tasarım, Reagan’ın özgürlük yolunda attığı kararlı adımları temsil eder. Heykelin hemen önündeki plaket, Macar halkının ona duyduğu minnettarlığı ifade eder.
Bugün Ronald Reagan Heykeli, Budapeşte’de sadece bir Amerikalı başkanın değil, aynı zamanda özgürlüğün, dayanışmanın ve uluslararası desteğin simgesi olarak ayakta durmaktadır. Ziyaretçiler için tarihi bir durak olmasının yanı sıra, totaliter rejimlere karşı kazanılmış özgürlüklerin ne kadar kıymetli olduğunu hatırlatan güçlü bir mesaj da taşımaktadır.`,
    story_en: `Located in Budapest’s Szabadság Square, the Ronald Reagan Statue stands as a symbolic tribute to freedom and the fight against totalitarian regimes. The statue honors former U.S. President Ronald Reagan, recognizing his significant role in the liberation of Hungary and other Central European nations from Soviet influence.
During the 1980s, at the final stages of the Cold War, Reagan became widely known for his pro-freedom policies and firm stance against the Soviet Union. Countries like Hungary drew strength from the West’s political posture shaped under his leadership. Reagan famously referred to the Soviet regime as the “evil empire” and led economic and ideological efforts that hastened the decline of the Eastern Bloc. His leadership inspired the profound political changes that eventually led to the fall of communism in Hungary.
The statue’s location adds another layer of symbolism. Szabadság Square represents both the historical presence of Soviet influence and the modern embrace of democratic values. Depicted walking forward, the statue of Reagan signifies his determined steps toward liberty. The plaque in front of the statue expresses the Hungarian people’s gratitude for his contributions.
...
This reflects his sense of duty and integrity. Due to Romanian objections, the statue was designed with Bandholtz holding his arms behind his back, omitting the riding crop. The original riding crop is now displayed in the Hungarian National Museum.
The statue was removed in 1949 by the Communist government under the pretext of restoration. It was later placed in the garden of the U.S. Ambassador's residence. In 1989, just before President George Herbert Walker Bush's visit to Budapest, the statue was returned to its original location in Liberty Square. Today, it stands as a symbol of freedom and the protection of national treasures.`,
  ...
  },
  {
    ...
    story_tr: `Budapeşte’nin tarihî Jewish Quarter (Eski Ghetto) bölgesindeki Dob utca 12 adresinde, Carl Lutz Anıt Taşı sessiz ama güçlü bir duruşla ziyaretçilerini karşılar. Bu anıt, 1991 yılında heykeltıraş Tamás Szabó tarafından yaptırılmıştır ve duvar tabloları ile bir taş sütundan oluşur; bir melek figürünün koruduğu düşen birini betimler 
Carl Lutz, 1942–45 yılları arasında İsviçre’nin Budapest’teki vekil konsolosu olarak görev yapmış bir diplomattı. Nazi zulmü altındaki Macar Yahudiler için “koruma mektupları” düzenleyerek yaklaşık 62.000 hayat kurtarmıştır 
Ayrıca Vadász utca’daki ünlü “Glass House”u ‘güvenli bölge’ ilan ederek binlerce kişiye sığınak sağlamıştır 
Anıtta yer alan yazıt, Talmud’dan alınan şu anlamlı sözü içerir: 
“Her kim bir hayat kurtarırsa, tüm dünyayı kurtarmış sayılır.”
Bu ifade, Lutz’un insanlık onuru ve vicdanı adına yaptığı fedakârlığı güçlü şekilde özetler. Anıtın konulduğu yer, daha önce bir hapishane binası idi ve burada ilk Macar başbakanı Batthyány Lajos da idam edilmişti; böylelikle bu taş hem kurtuluş hem de zulüm simgesidir.
Ziyaretçilerin önü duvarlar arasında ilerlerken bu taşla karşılaşması, tarihin yükünü hissetmek, insanlığı hatırlamak ve bugün hâlâ geçerli bir mesajı kavramak anlamına gelir: bazen bir diplomatik mektup ya da bir binanın diplomatik sınır altına alınması, hayatları değiştirebilir. Carl Lutz Anıt Taşı, tıpkı onun ruhu gibi sessiz ama unutulmaz bir hatıradır.`,
    story_en: `At Dob utca 12 in Budapest’s historic Jewish Quarter, a solemn monument honors the courageous Swiss diplomat Carl Lutz. Commissioned in 1991 and crafted by sculptor Tamás Szabó, the memorial combines a stone pillar with a wall-mounted plaque depicting an angel protecting a fallen figure 
Carl Lutz served as the Swiss Vice-Consul in Budapest from 1942 to 1945. He is credited with saving approximately 62,000 Hungarian Jews by issuing protective “Schutzbriefe” and establishing around 70 safe houses, including the notorious Glass House at Vadász Street 
The Talmudic inscription on the memorial reads:
“Whoever saves a life is considered as if he has saved an entire world.”
This quote encapsulates the moral weight of Lutz’s actions 
The site itself deepens the symbolism. It was once the location of a prison where Hungary’s first Prime Minister, Lajos Batthyány, was executed in 1849—making the monument both a tribute to liberation and a reminder of suffering.
When visitors come upon this quiet corner tucked off the main square, they don’t just see a stone memorial—they encounter a lesson about moral courage, the power of diplomacy, and the lasting impact of compassionate action. Carl Lutz’s memorial lives on as a timeless testament: in silence, he saved worlds.`,
    image:
  ...
  },
  {
    ...
    story_tr: `Budapeşte’nin simgesel buluşma noktalarından biri olan Özgürlük Meydanı'ndaki George Herbert Walker Bush Heykeli, yalnızca bir anıt değil; iki ülke arasında demokrasiyi ve özgürlük fikrini taşıyan güçlü bir semboldür. 2020 yılı 30 Ekim tarihiyle, George Herbert Walker Bush’un anısına dikilen bu bronz heykel, 1989’da Soğuk Savaş’ın sona ermesinde Batı dünyasının desteğini temsil eder ve Reagan heykelinin hemen yanına yerleştirilmiştir 
George Herbert Walker Bush, 1989’da henüz görevdeyken Budapeşte’ye yaptığı tarihi ziyarette, Kossuth Meydanı’nda yaptığı konuşmada Sovyet etkisinden kurtulma arzusu taşıyan Macar gençliğine destek verdi:
“Bize Yalta’dan kurtarın” diye talepte bulundular. Ben de onların bu dileğini destekledim...
Macaristan’ın özgürlüğe açılan kapılarından biri oldu 
Heykelin ön yüzünde dönemin Macar Başbakanı Viktor Orbán’ın “Her Macar bilir ki ABD, özgürlüğün topraklarıdır…” sözleri ve Bush’un Avrupa’nın geleceğine olan katkıları anlatılmıştır 
Heykelin yapımcısı Máté István'dır ve tam boyutlu bronz formuyla meydanda hem mimari bir ahenk hem de tarihle diyalog kurar 
Heykel Reagan, Bandholtz ve Sovyet Anıtı ile birlikte bir üçgen oluşturur; bu da Soğuk Savaş’ın farklı temsillerine meydanda sembolik bir diyalog kazandırır. Özgürlük Meydanı artık sadece bir fiziksel alan değil; uluslararası işbirliğinin, barışın ve demokrasi mücadelesinin ikonografisi haline gelmiştir.`,
    story_en: `At the heart of Budapest’s Liberty Square , the statue of George Herbert Walker Bush stands not merely as a monument, but as a powerful symbol of enduring friendship between Hungary and the United States. Unveiled on October 27, 2020, this full-length bronze statue honors the 41st U.S. President and his pivotal role in supporting freedom during the final chapters of the Cold War—placed beside the Ronald Reagan statue to complete a symbolic duo. 
In 1989, still in office, President Bush visited Budapest and delivered a heartfelt speech at Kossuth Square, expressing solidarity with Hungarian youth who implored him to “deliver us from Yalta.” His words echoed a shared vision of Central Europe’s freedom and independence. 
The inscription on the statue references remarks by Hungarian Prime Minister Viktor Orbán: "Every Hungarian knows America is the land of freedom." It reflects Bush’s legacy in helping reshape Europe’s future and Hungary's political destiny. Created by sculptor István Máté, the statue's dignified bronze presence bridges American leadership and Hungarian history. 
Positioned alongside the statues of Ronald Reagan, Harry Hill Bandholtz, and the Soviet War Memorial, the Bush statue completes a symbolic narrative within the square—each sculpture representing different aspects of Cold War history and freedom’s journey.`,
    image:
  ...
  },
  {
    ...
    longitude: 19.046240275045186,
    story_tr: `Budapeşte'nin V. semtinde Széchenyi rakpart ile Markó utcası köşesinde, Olimpia Park yanında yükselen bu bronz heykel, Anna Kéthly’nin adını taşıyan küçük meydanın duygusal merkezidir. Macar demokratik siyasetine adını yazdırmış bir siyasetçi olarak Kéthly başlı başına bir sembol olsa da, heykel bu anlamı sade ama güçlü bir şekilde aktarır 
Anna Kéthly (1889–1976), ikinci kadın milletvekili ve 1956 Macar Devrimi sırasında yeniden kurulan Sosyal Demokrat Parti’nin devlet bakanı olarak görev yapmıştır. Nazilerin ardından Sovyet rejimine karşı verdiği mücadele, onun özgürlük, eşitlik ve demokrasi savunucusu olarak tanınmasını sağlamıştır 
Heykel, 2015 yılının Kasım ayında heykeltıraş Nagy Benedek tarafından dikilmiştir. Yaklaşık iki metre boyundaki bronz heykel, yanında granit sütunlarla birlikte sade bir duruşla meydanı doldurur. Onun bakışı ileri dönüktür; geçmişle geleceği, mücadeleyle umut arasındaki köprüyü gösterir 
Anna Kéthly, Macar siyaseti içinde cesareti, duruşu ve adanmışlığıyla “Macar siyaseti Jeanne d’Arc’ı” diye anılmıştır. Heykelin eteğinde yer alan plaket, demokrasiye verdiği söz ve bu söz uğruna ödediği bedeli hatırlatır 
Bu meydanda yürüyen ziyaretçiler yalnızca bir heykele bakmaz. Aynı zamanda bir dönemi, bir kadın liderin cesaretini ve özgürlüğe dair umutları hisseder. Anna Kéthly Heykeli, sessiz duruşuyla konuşur: “Diyor ki; ses çıkaranlar unutulmaz.”`,
    story_en: `At the corner of Széchenyi Embankment and Markó Street, beside Olimpia Park in Budapest’s District V, stands the bronze statue of Anna Kéthly in a small square named in her honor. While Anna Kéthly herself embodies democratic political courage, the statue conveys her legacy in a simple yet powerful form 
Anna Kéthly (1889–1976) was the second female member of the Hungarian National Assembly and served as State Minister during the Hungarian Revolution of 1956 as part of the reestablished Social Democratic Party. Her life’s work represented defiance against fascist and communist repression and unwavering dedication to freedom, equality, and democracy 
Created by sculptor Benedek Nagy and unveiled in November 2015, the statue stands nearly two meters tall in bronze, paired with granite columns that visually ground the space. Her gaze is forward—symbolizing the bridge between past struggles and future hope 
...
`,
    story_en: `Located on the southern side of Kossuth Square, near the Hungarian Parliament, stands the statue of Béla Kovács — a powerful yet understated tribute to a key figure in Hungary’s postwar democratic movement. Created by sculptor Sándor Kligl and unveiled on February 26, 2002, the bronze figure leans casually on a railing, capturing both modesty and resolve. The plaque reads “Béla Kovács / 1908–1959” and includes the phrase “state politician wrongfully deported by Soviet authorities,” honoring his unjust persecution.
